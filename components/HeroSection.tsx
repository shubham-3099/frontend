        ...
        <div className="flex flex-col items-center lg:flex-row md:justify-center my-10 md:my-25 md:px-20 gap-10">
            <div className="flex flex-col gap-8 justify-center w-[340px] md:w-[600px] md:mr-40">
                ...
                <div className="flex gap-4 pb-5">
                    <button onClick={() => router.push("/home")} className="border px-4 py-2"> Search </button>
                    <button onClick={() => router.push("/home")} className="flex items-center"> Explore <ChevronRight className="w-5 h-4 mt-1" /> </button>
                </div>
            </div>
